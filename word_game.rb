...
def word_game
    ...
    while true
        ...
        if code == 2  # Initialize new word and update neccessary data
            ...
            related_word_len = data_syn_ant[0]["words"].length()
        ...
        if code == 3 # Show one def or syn
             if related_word_cnt < related_word_len && flag == 1
                 puts "HINT :: Synonym / Antonym : " + data_syn_ant[0]["words"][related_word_cnt] + "\n"
                 related_word_cnt = related_word_cnt + 1
                 flag = 0
                ...
                flag = 1
                if related_word_cnt == related_word_len
                    flag = 0
                end
                puts flag
             end
